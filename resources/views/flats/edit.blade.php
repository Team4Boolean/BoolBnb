                      ...
                      <div class="form-row">
                        ...
                        <section class="textInput col-lg-7 col-md-6">
                          ...
                          <div id="input-title" class="input-group mb-3">
                            ...
                            <input class="form-control @error('title') is-invalid @enderror" type="text" name="title" value="{{old('title', $flat-> title)}}">
                            @error('title')
                          ...
                          <div id="input-desc" class="form-group">
                            ...
                            <textarea class="form-control @error('desc') is-invalid @enderror" name="desc" rows="8" cols="80">{{old('desc', $flat-> desc)}}</textarea>
                            @error('desc')
                              <span class="invalid-feedback" role="alert">
                                  <strong>{{ $message }}</strong>
                              </span>
                        ...
                        <section class="numInput  offset-md-1 col-lg-4 col-md-5 pt-4">
                          ...
                          <div class="input-group mb-4">
                            ...
                            <input class="form-control @error('sqm') is-invalid @enderror" type="number" name="sqm" value="{{ old('sqm', $flat -> sqm) }}">
                            <div class="input-group-prepend">
